...
public interface IPGType {
    final String LBL_DO_WITH = "//select[contains(@id,'lbl-DoWith')]";
    final String CBB_IPGTYPE = "//select[contains(@id,'cbb-IpgType')]";
    
    final String CBB_IPGTYPE_PROVINCE_VALUE = "1";
    final String CBB_IPGTYPE_DISTRICT_VALUE = "2";
