...
public class LandNearRoadDAO {
    ...
    public ArrayList<LandNearRoad> getLandNearByRoadId(String id) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                RoadSegment roadSegment = capstone.lip.landinformationportal.dao.RoadSegmentDAO.roadSegmentDAO.getRoadSegmentByRoadSegmentID(rs.getInt("RoadSegmentID"));
                ArrayList<Coordinate> listCoordinate = capstone.lip.landinformationportal.dao.CoordinateDAO.coordinateDAO.getListCoordinateWithLandNearRoadID(landNearRoadId);
                ArrayList<RealEstateObject> listReo = capstone.lip.landinformationportal.dao.ReoDAO.reoDAO.getListReoByLandNearRoadID(landNearRoadId);
    ...
    public int deleteLandNearRoadById(String idLandNearRoad) throws Exception {
        ...
        ArrayList<Coordinate> listCoordinate = capstone.lip.landinformationportal.dao.CoordinateDAO.coordinateDAO.getListCoordinateWithLandNearRoadID(id);
        int deleteCoordinate = capstone.lip.landinformationportal.dao.CoordinateDAO.coordinateDAO.deleteCoordinateByCoordinateId(listCoordinate);
    ...
    public int insertNewLandNearRoad(LandNearRoad landNearRoad) throws Exception {
        ...
        try {
            ...
            int insertCoordinate = capstone.lip.landinformationportal.dao.CoordinateDAO.coordinateDAO.insertCoordinate(landNearRoad.getListCoordinate());
