...
import capstone.lip.landinformationportal.entity.Feature;
    ...
    public ArrayList<RealEstateObject> getListReoByLandNearRoadID(int landNearRoadId) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ArrayList<Feature> listFeature = capstone.lip.landinformationportal.dao.FeatureDAO.featureDAO.getListFeatureByReoID(reoId);
                ArrayList<Coordinate> listCoordinate = capstone.lip.landinformationportal.dao.CoordinateDAO.coordinateDAO.getListCoordinateWithReoID(reoId);
